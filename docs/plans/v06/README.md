...
| 02 | 2026-05-16-v06-02-extractor-registry.md | 확장자별 extractor를 선택하는 registry 구현 | Pending |
| 03 | 2026-05-16-v06-03-text-markdown-html-extractors.md | `.txt`, `.md`, `.html` extractor 구현 | Pending |
