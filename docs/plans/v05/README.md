...
| 04 | 2026-05-16-v05-04-local-source-integration.md | text_note, markdown_file, plain_text_file을 Local Storage ingest로 연결 | **Completed** 2026-05-16 |
| 05 | 2026-05-16-v05-05-url-integration.md | 사용자가 제공한 단일 URL을 fetch하고 Local Storage ingest로 연결 | **Completed** 2026-05-16 |
| 06 | 2026-05-16-v05-06-rebuild-integration.md | ingest 이후 wiki, FTS, graph rebuild를 process_source.py에 연결 | **Completed** 2026-05-16 |
| 07 | 2026-05-16-v05-07-notion-payload-integration.md | 처리 결과를 안전한 Notion update payload로 변환 | **Completed** 2026-05-16 |
| 08 | 2026-05-16-v05-08-tests-and-runbook.md | 테스트, runbook, handoff, workflow 문서 정리 | **Completed** 2026-05-16 |
