...
- Last completed task: v08-05 domain graph rebuild CLI
- Next task: v08-06 graph export
...
5. `docs/plans/v08/2026-05-17-v08-05-domain-graph-rebuild-cli.md`
6. `tools/rebuild_domain_graph.py`
7. `tests/test_domain_graph_rebuild.py`
8. `src/domain_graph/storage.py`
...
- v08-07 이후 report/derived wiki/retrieval 구현을 v08-06 완료 전 앞당기지 않는다.
...
docs/plans/v08/2026-05-17-v08-05-domain-graph-rebuild-cli.md
...
v08 scope is open by maintainer request. Continue with v08-06 after v08-05 is committed and pushed.
