...
- Last completed task: v08-04 graph storage/upsert
- Next task: v08-05 domain graph rebuild CLI
...
5. `docs/plans/v08/2026-05-17-v08-04-graph-storage-upsert.md`
6. `src/domain_graph/storage.py`
7. `tests/test_domain_graph_rebuild.py`
...
- v08-05: domain graph rebuild CLI

아직 하지 말 것:

- v08-06 이후 export/report/derived wiki/retrieval 구현을 v08-05 완료 전 앞당기지 않는다.
...
docs/plans/v08/2026-05-17-v08-04-graph-storage-upsert.md
...
v08 scope is open by maintainer request. Continue with v08-05 after v08-04 is committed and pushed.
